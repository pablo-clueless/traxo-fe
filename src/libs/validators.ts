...
export const VALIDATOR_MINLENGTH = (val: any) => ({type: VALIDATOR_TYPE_MINLENGTH, val: val})
export const VALIDATOR_MAXLENGTH = (val: any) => ({type: VALIDATOR_TYPE_MAXLENGTH, val: val})
